...
from without_dummy.functions.func_jn import jackknife_rolling_window
...
def main():
    ...
    for lag in range(1, 13):
        ...
        rmse_cpi[lag] = results[f'jn{lag}c']['errors']['rmse']
        rmse_pce[lag] = results[f'jn{lag}p']['errors']['rmse']
