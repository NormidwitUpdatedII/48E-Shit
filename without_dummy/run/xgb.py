"""
XGBoost Rolling Window Forecasts
"""
import os
import sys
import numpy as np
...
from without_dummy.functions.func_xgb import xgb_rolling_window
...
def main():
    ...
    for lag in range(1, 13):
        ...
        rmse_cpi[lag] = results[f'xgb{lag}c']['errors']['rmse']
        rmse_pce[lag] = results[f'xgb{lag}p']['errors']['rmse']
